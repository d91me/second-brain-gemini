...
```
Telegram → Deepgram → Gemini CLI → Todoist + Obsidian vault → Telegram report
```
...
- `vault/.gemini/skills/dbrain-processor/references/about.md` - tell the agent about yourself
- `vault/.gemini/skills/dbrain-processor/references/classification.md` - how you want entries sorted
...
| `vault/.gemini/GEMINI.md` | Agent personality and rules |
