...
uv run vault/.gemini/skills/vault-health/scripts/generate_moc.py

# Find who links to a file
bash vault/.gemini/skills/vault-health/scripts/backlinks.sh "business/crm/acme-corp"

# Find and fix broken links (dry run)
uv run vault/.gemini/skills/vault-health/scripts/fix_links.py

# Apply fixes
uv run vault/.gemini/skills/vault-health/scripts/fix_links.py --apply
```
...
bash vault/.gemini/skills/vault-health/scripts/backlinks.sh "MEMORY"
```
...
Detailed template: `.gemini/rules/weekly-reflection.md`
...
- `.gemini/rules/weekly-reflection.md` — template for weekly reflections
