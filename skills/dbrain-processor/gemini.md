...
```
1. ВЫЗОВИ: todoist find-tasks-by-date '{"startDate": "today"}'
   ↓
...
9. **Log actions to daily** — append action log entry
10. **Evolve MEMORY.md** — update long-term memory if needed
11. **Capture observations** — record friction signals to handoff.md
...
| Тип | Когда |
|-----|-------|
| `[friction]` | errors, timeouts, empty daily, broken links, unexpected data |
...
```markdown
## Observations
- [friction] YYYY-MM-DD: timeout 3x на todoist — retry спас, но -60 сек
