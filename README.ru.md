...
```
Telegram → Deepgram → Gemini CLI → Todoist + Obsidian → Telegram отчёт
```
...
- `vault/.gemini/skills/dbrain-processor/references/about.md` - расскажи агенту о себе
- `vault/.gemini/skills/dbrain-processor/references/classification.md` - как сортировать записи
...
| `vault/.gemini/GEMINI.md` | Личность и правила агента |
